    ...
    <>
      ...
      <div className="max-w-[86rem] mx-auto overflow-hidden">
        ...
        <div className="px-[30px] md:px-[40px]">
          ...
          <div className="flex  justify-between flex-wrap ">
            {services.map(({ src, title }) => {
              return (
                <div className="mb-[2rem] md:mx-2 md:my-4 w-[100%] sm:w-[40%] md:w-[30.33%] lg:w-[20%] flex-col items-center rounded-md  ">
        ...
        <div className=" p-[40px] pt-[100px] w-full hidden sm:block">
          ...
          <div
            className=" sm:h-[1200px] md:h-[1800px] lg:h-[3500px] xl:h-[2360px] py-4 flex  flex-col "
            style={{ flexWrap: "wrap" }}
          >
        ...
        <div className="w-full sm:hidden pt-[50px]">
          <h1 className="flex justify-center text-[27px] mb-[20px]">Sample Works</h1>
