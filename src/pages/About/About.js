...
const About = () => {
  const Faq = [
    ...
    },
    {
      ...
      solution:
        "We offer a number of payment options, including  PayPal, Wise, Payoneer, credit and debit card.",
    },
    {
