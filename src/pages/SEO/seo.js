...
function seo() {
  const arrayFaq = [
    ...
    {
      question: "How can we start a campaign for SEO on my website?",
      solution:
    ...
    {
      question: "How do you do eCommerce SEO for product pages?",
      solution:
  ...
  const array = [
    ...
    },
    {
      ...
      description:
        "A sitemap is essential for SEO. Sitemaps help search engine bots better craw| your site and reduce the risk of overlooking parts of it.",
    },
    {
  ...
  const herotext2 = "We offer a range of services including keyword research, on-page optimization, technical SEO, content marketing, and more, all designed to boost your website's ranking on search engines and drive qualified traffic to your site. Let us help you take your online presence to the next level."
    const service_headline = "Why You Need SEO for Your Website?";
  const height = "h-[15rem] md:h-[20rem]";
  return (
    <div>
      <HomeTwoHeader />
      <CommonPageHeader
